...
- Upon success, you should be able to see something similar in your cli.
    
    ![thirdweb cli.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/8275ab38-1c00-4008-97e5-84c4b897d398/thirdweb_cli.png)
    ...
    - After the transactions are mined you will be taken to the dashboard which consists of many options.
        ...
        ![Screen Shot 2022-08-13 at 3.14.40 PM.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/ad8e70f8-ee05-4912-8ffa-9770d9882cf0/Screen_Shot_2022-08-13_at_3.14.40_PM.png)
    ...
    ***Step 8:***
    ...
    // setting it up to the array state we declared above
    setTodos(todosData);
    } catch (err) {
    console.error(err);
    }
    ...
    [console.info](http://console.info/)("Contract call successfull!", data);
    await getTodos();
    } catch (err) {
    console.error(err);
    }
    ...
    ***Step 9:*** 
    ...
    Let’s write code for out List.tsx file.
    ...
    ***Step 10:*** 
    ...
    . [To see the entire code click here](https://github.com/Abbas-Khann/thirdweb-deploy-todo-dApp)
